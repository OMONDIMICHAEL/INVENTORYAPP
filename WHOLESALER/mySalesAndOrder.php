                ...
                <div class="col-md-8 col-lg-8 col-xl-8 mx-auto mb-4" id="bodyGridDiv">
                    <article id="bodyArt">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" id="mySalesBtn" class="btn btn-primary"  data-mdb-ripple-init>MY SALES</button>
                            <button type="button" id="makeOrderBtn" class="btn btn-primary"  data-mdb-ripple-init>ORDER PRODUCT</button>
                            <button type="button" id="myOrdersBtn" class="btn btn-primary"  data-mdb-ripple-init>MY ORDERS</button>
                        </div>
                                    ...
                                    foreach ($orders->fetchAll(PDO::FETCH_ASSOC) as $gottenProduct) {
                                        echo"
                                            <div class='card'>
                                                ...
                                                "?>
                                                    <img src="<?php echo $gottenProduct['productImagePath']; ?>" class='img-fluid' alt='<?php echo $gottenProduct['productImagePath']; ?>'/>
                                                    <?php echo "
                                                    <a href='wholesalerProductToOrder.php?productId="?><?php echo $gottenProduct['productId'];?><?php echo "'>
